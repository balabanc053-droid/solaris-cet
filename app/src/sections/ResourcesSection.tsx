  ...
  },
  {
    ...
    resources: [
      ...
      },
      {
        ...
        description: 'Comprehensive free guide by DAIR.AI covering prompt engineering techniques essential for optimising AI agents, with tutorials and research papers.',
